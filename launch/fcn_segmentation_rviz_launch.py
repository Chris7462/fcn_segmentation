...
def generate_launch_description():
    pkg_share = get_package_share_directory('fcn_segmentation')
    ...
    fcn_segmentation_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            join(pkg_share, 'launch', 'fcn_segmentation_launch.py')
        ),
        launch_arguments={
    ...
    rviz_node = Node(
        ...
        executable='rviz2',
        name='rviz2',
        arguments=['-d', join(pkg_share, 'rviz', 'fcn_segmentation.rviz')]
    )
